...
const dict: Record<string, string> = {
  ...
  "DOTA_Tooltip_ability_item_winter_stocking_Description": "Bruk: Åpne strømpen for å motta dine gaver!",
  "DOTA_Tooltip_ability_item_winter_coco": "Cocoa with Marshmallows",
  "DOTA_Tooltip_ability_item_winter_coco_Description": "Bruk kakaoen for å helbrede 300 helse og 150 mana i løpet av 14 sekunder",
